...
import { rsvpContacts, weddingDate } from "@/lib/wedding-data";
      ...
      <div className="relative mx-auto max-w-6xl px-6 sm:px-10">
        <RevealOnScroll>
          <SectionHeading
            ...
            tone="light"
            description={`Kindly let us know whether you will be joining us by ${weddingDate.rsvpDeadline}.`}
          />
        </RevealOnScroll>

        <div className="mt-14 grid grid-cols-1 gap-10 lg:grid-cols-[1.45fr_0.75fr] lg:gap-14">
          <RevealOnScroll>
          ...
          <RevealOnScroll delayMs={140}>
            <aside className="flex h-full flex-col gap-8 rounded-[2rem] border border-ivory/15 bg-ivory/5 p-8 backdrop-blur-sm sm:p-10">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm leading-relaxed text-fog/85">
                  Our RSVP coordinators are happy to help by phone or WhatsApp.
                </p>
              </div>
                ...
                {rsvpContacts.map((contact) => (
                  ...
                  >
                    <div className="flex flex-col">
                      <span className="font-serif text-lg text-ivory">{contact.name}</span>
